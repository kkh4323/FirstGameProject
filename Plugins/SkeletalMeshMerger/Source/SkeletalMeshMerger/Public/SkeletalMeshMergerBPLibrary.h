// Copyright Epic Games, Inc. All Rights Reserved. Code provided by Epic Games, put into plugin for use as Blueprint node by me.
...
#include "SkeletalMeshMergerBPLibrary.generated.h"
/**
...
public:
    ...
    */
    UFUNCTION(BlueprintCallable, DisplayName = "Merge Meshes", Category = "Mesh Merge", meta = (UnsafeDuringActorConstruction = "true"))
